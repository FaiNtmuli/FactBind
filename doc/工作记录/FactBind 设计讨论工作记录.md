...
本文记录的是讨论过程和方向取舍。讨论的落地结果见：

- 《FactBind v0.1 设计文档》—— v0.1 的实际形态、文件清单、工作机制、与基线的差异账、已知瑕疵
- 《FactBind v0.1 使用指南》—— 从基线装工具、写契约、改调用点的完整操作步骤与报错对照
- 《FactBind v0.1 演示方案》—— 15 分钟演示的分幕脚本、实测输出对照、兜底预案与问答

三份文档对应分支 `factbind-min`（v0.1 本体）；`main` 是不含 FactBind 的对照基线。
